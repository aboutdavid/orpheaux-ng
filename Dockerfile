...
ADD --chown=runner:runner https://github.com/ungoogled-software/ungoogled-chromium-portablelinux/releases/download/124.0.6367.118-1/ungoogled-chromium_124.0.6367.118-1_linux.tar.xz /chrome.tar.xz
